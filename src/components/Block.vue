    ...
    export default {
        ...
        methods: {
            ...
            successFunction(){
                ...
                document.getElementsByClassName('drag_bg')[0].style.width = this.maxwidth +40 + 'px';
                if(this.confirmSuccess == true){
                    ...
                    request.AJAX(this.$AjaxUrl.huadong,params,"huadong",This).then(()=>{
                        console.log(this.$store.state.huadong.data.data.expired_time);
                    })
                }
            ...
            mouseMoveFn(e){
                if(this.mouseMoveStata){
                    ...
                    if(width>0 && width<=this.maxwidth){
                        ...
                        document.getElementsByClassName('drag_bg')[0].style.width = width +40 + 'px';
